...
This skill is wired into the [[ICARUS Multi-Directional Thinking Chronology]] at **Phases 3 (Belief) and 7 (Innovation)**.

**Mindsets activated with this skill:**
- `[[Steve Jobs Mindset]]` — AI should sell belief, never features. Every Genkit AI response must carry the Jobs belief-first DNA.
- `[[Knight (Nike Mindset)]]` — AI should sell identity, not outputs. Users don't want AI answers; they want to BECOME the person who has those answers.
- `[[Ogilvy (Rolls Royce Mindset)]]` — AI should find the one true sentence in every response and say it louder than everything else.
- `[[TRAQA INTEL]]` — Traqa's report intelligence runs on this logic.

**Customization note:** To disable specific mindsets on this skill, say: "Run firebase-ai-logic without Ogilvy."
