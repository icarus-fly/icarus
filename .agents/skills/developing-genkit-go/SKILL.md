...
**Thinking Chronology Phase:** Phase 6 (Architecture — backend AI services), Phase 7 (Innovation — R&D experimentation).

**Vault connections:**
- `[[TECHNOLOGY BRAIN]]` — Backend AI architecture in Go. If Traqa's cloud functions or microservices use Go, this skill powers the AI layer.
- `[[Musk]]` — First-principles AI architecture. Genkit Go enables building AI from the ground up rather than using black-box solutions. Build the AI stack that competitors can't replicate.
- `[[Clayton Christensen]]` — Disruptive innovation through AI. Genkit Go enables building AI features that incumbents can't offer because their architecture is too rigid. This is the disruptor's advantage.

**Customization:** "Run genkit-go without Christensen."
