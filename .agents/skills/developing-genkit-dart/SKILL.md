...
**Thinking Chronology Phase:** Phase 6 (Architecture — backend AI infrastructure), Phase 7 (Innovation — R&D).

**Vault connections:**
- `[[TECHNOLOGY BRAIN]]` — Backend AI architecture in Dart. Every Genkit flow is an architectural decision that shapes how Traqa's AI features work.
- `[[TRAQA]]` — Traqa's Flutter app runs on Dart. Genkit Dart powers the AI engine behind report analysis, health insights, and family health intelligence.
- `[[Nikola Tesla]]` — Innovation in AI architecture. Genkit enables R&D possibilities that competitors aren't exploring — like real-time health report interpretation at the edge.
- `[[MARKETING OS]]` — The AI features built with Genkit determine what the product can market. If Genkit enables a unique AI feature, it becomes the marketing narrative.

**Customization:** "Run genkit-dart without Marketing OS."
