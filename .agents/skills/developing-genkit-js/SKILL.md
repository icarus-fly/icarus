...
**Thinking Chronology Phase:** Phase 6 (Architecture — web/mobile AI integration), Phase 7 (Innovation — rapid prototyping).

**Vault connections:**
- `[[TECHNOLOGY BRAIN]]` — Frontend and backend AI integration in JS/TS. Genkit JS connects the AI brain to the web interface.
- `[[TRAQA]]` — Traqa's web frontend and cloud functions use JS/TS. This skill powers the AI that shows users their health insights.
- `[[Davinci]]` — Interdisciplinary creativity. Genkit JS enables connecting AI to every part of the product — frontend, backend, marketing, analytics. Da Vinci's cross-domain thinking applied to AI architecture.
- `[[Ogilvy (Rolls Royce Mindset)]]` — Every AI-generated response delivered through Genkit JS should carry the one true sentence. The AI shouldn't just output data — it should communicate with Ogilvy's clarity.

**Customization:** "Run genkit-js without Ogilvy."
